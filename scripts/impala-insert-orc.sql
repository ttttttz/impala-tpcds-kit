...
select /*+ COALESCE(5) */ cs_sold_time_sk,
       cs_ship_date_sk,
       cs_bill_customer_sk,
       cs_bill_cdemo_sk,
       cs_bill_hdemo_sk,
...
select /*+ COALESCE(5) */ cr_returned_time_sk,
       cr_item_sk,
...
select /*+ COALESCE(5) */ ss_sold_time_sk,
       ss_item_sk,
       ss_customer_sk,
       ss_cdemo_sk,
       ss_hdemo_sk,
...
select  /*+ COALESCE(5) */ sr_return_time_sk,
       sr_item_sk,
       sr_customer_sk,
       sr_cdemo_sk,
       sr_hdemo_sk,
...
select /*+ COALESCE(5) */ ws_sold_time_sk,
       ws_ship_date_sk,
       ws_item_sk,
       ws_bill_customer_sk,
       ws_bill_cdemo_sk,
...
select /*+ COALESCE(5) */ wr_returned_time_sk,
       wr_item_sk,
...
--非分区测试，count\count(distinct)
use tpcds_10000_orc;
insert overwrite table store_sales_100
...
insert overwrite table store_sales_1000
select /*+ repartition(1000) */ ss_sold_time_sk,
                            ss_item_sk,
                            ss_customer_sk,
                            ss_cdemo_sk,
                            ss_hdemo_sk,
...
insert overwrite table store_sales_2000
select /*+ repartition(2000) */ ss_sold_time_sk,
                             ss_item_sk,
                             ss_customer_sk,
                             ss_cdemo_sk,
                             ss_hdemo_sk,
